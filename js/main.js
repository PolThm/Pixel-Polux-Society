 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    i.env() && (i.location = function () {}),
      ...
      (i.destroy = function (t) {
        (t = t || {}), (p = !0), u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), d.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), (o = []), (a = []), "pending" === E.state() && L();
      }),
      s(i.ready),
      L(),
    ...
    window.tram = (function (t) {
      ...
      var l = (function (t, e, n) {
        ...
        S = function (t) {
          ...
          for (e = 0; e < T.length; e++) if ((n = T[e] + i) in O.style) return { dom: n, css: C[e] + t };
        },
      ...
      if (R.transition) {
        var I = R.timing.dom;
        if (((O.style[I] = d["ease-in-back"][0]), !O.style[I])) for (var z in f) d[z][0] = f[z];
      }
      var M = (e.frame = (function () {
          ...
          (t.init = function (t, e, n, i) {
            ...
            K[o] && (o = K[o]),
              ...
              U.fallback || i.fallback
                ...
                : ((this.animate = this.transition), (this.string = this.name + L + this.duration + "ms" + ("ease" != this.ease ? L + d[this.ease][0] : "") + (this.delay ? L + this.delay + "ms" : "")));
          }),
            (t.set = function (t) {
            ...
            (t.fallback = function (t) {
              ...
              this.auto && ("auto" == n && (n = this.convert(this.get(), this.type)), "auto" == t && (t = e.call(this))),
                (this.tween = new W({ from: n, to: t, duration: this.duration, delay: this.delay, ease: this.ease, update: this.update, context: this }));
            }),
            (t.get = function () {
        ...
        F = l(D, function (t, e) {
          ...
          (t.init = function () {
            e.init.apply(this, arguments), this.current || ((this.current = {}), Z.perspective && U.perspective && ((this.current.perspective = U.perspective), G(this.el, this.name, this.style(this.current)), this.redraw()));
          }),
            (t.set = function (t) {
        ...
        B = l(W, function (t, e) {
          (t.init = function (t) {
            ...
            for (e in ((this.context = t.context), (this.update = t.update), (this.tweens = []), (this.current = t.current), t.values))
              (n = t.values[e]), this.current[e] !== n && this.tweens.push(new W({ name: e, from: this.current[e], to: n, duration: t.duration, delay: t.delay, ease: t.ease, autoplay: !1 }));
            this.play();
          }),
            (t.render = function (t) {
              var e,
        ...
        U = (e.config = { debug: !1, defaultUnit: "px", defaultAngle: "deg", keepInherited: !1, hideBackface: !1, perspective: "", fallback: !R.transition, agentTests: [] });
      ...
      var G = t.style,
        ...
        Z = {};
      R.transform && ((Y.transform = [F]), (Z = { x: [x, "translateX"], y: [x, "translateY"], rotate: [E], rotateX: [E], rotateY: [E], scale: [g], scaleX: [g], scaleY: [g], skew: [E], skewX: [E], skewY: [E] })),
      R.transform && R.backface && ((Z.z = [x, "translateZ"]), (Z.rotateZ = [E]), (Z.scaleZ = [g]), (Z.perspective = [y]));
      var Q = /ms/,
        V = /s|\./;
      return (t.tram = e);
    })(window.jQuery);
  ...
  function (t, e, n) {
    n(3), n(7), n(8), n(9), n(10), n(11), n(12), n(13), (t.exports = n(14));
  },
  function (t, e, n) {
    "use strict";
    var i = n(0);
          ...
          (n.ready = function () {
            ...
            ((e =
              ...
              ((n = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs")),
                (i = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon.f67cd735e3.svg").attr("alt", "").css({ marginRight: "8px", width: "16px" })),
            ...
            function () {
              (r = !0),
                ...
                (function (t) {
                  ...
                  t.ajax({ url: m("https://editor-api.webflow.com/api/editor/view"), data: { siteId: a.attr("data-wf-site") }, xhrFields: { withCredentials: !0 }, dataType: "json", crossDomain: !0, success: f(e) });
                });
            },
          l = !1;
        try {
  ...
  function (t, e, n) {
    ...
    i.define(
      ...
      (t.exports = function (t, e) {
        ...
        function j(t, e) {
          if (!t.open) {
            (t.open = !0), t.menu.each($), t.links.addClass(x), t.dropdowns.addClass(g), t.dropdownToggle.addClass(b), t.dropdownList.addClass(y), t.button.addClass(w);
            var n = t.config;
            ...
            var r = q(t),
              ...
              u = t.el.height(),
              c = t.el[0];
            if ((N(0, c), E.intro(0, c), i.redraw.up(), s || f.on("click" + m, t.outside), e)) p();
            else {
